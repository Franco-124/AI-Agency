      ...
      <ul className="mt-14 grid gap-5 md:grid-cols-3">
        {pillars.map(({ key, Icon }, index) => (
          <Reveal
            ...
            key={key}
            delay={index * 0.06}
            className="group relative flex flex-col rounded-xl border border-hairline bg-[var(--color-primario)] p-7 transition-colors duration-200 hover:border-hairline-strong"
          >
            <span
              aria-hidden
