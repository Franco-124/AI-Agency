...
export const leadSchema = z.object({
   ...
   *
   * The form no longer asks for a business name, a vertical or an interest
   * picker — this single free-text field is now the only thing that says what
   * the visitor actually wants, so a lead without it carries a name and two
